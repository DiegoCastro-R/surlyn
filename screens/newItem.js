...
const NewItem = ({ route, navigation }) => {
  ...
  const handleSubmit = () => {
    Toast.show({ type: 'success', text1: "Item adicionado com Sucesso" })
  };
    ...
    >
      ...
      <View style={styles.content}>
        ...
        <View style={styles.submitWrapper}>
          <SubmitButton customStyles={styles.submit} isMain={true} text='ADICIONAR NOVO ITEM' submitHandler={handleSubmit} />
        </View>
      </View>
