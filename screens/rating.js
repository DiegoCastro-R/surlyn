...
const Rating = ({ navigation, route }) => {
  ...
  const handleSubmit = () => {
    Toast.show({ type: 'success', text1: "Avaliação submetida com Sucesso" })
  };
    ...
    >
      ...
      <View style={styles.content}>
        ...
        <View style={styles.submitWrapper}>
          <SubmitButton customStyles={styles.submit} isMain={true} text='ENVIAR AVALIAÇÃO' submitHandler={handleSubmit} />
        </View>
      </View>
