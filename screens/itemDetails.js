            ...
            <ScrollView>
                <View>
                    ...
                    <View style={styles.buttonContainer}>
                        <Button style={{ width: 350, backgroundColor: "#5A9C54", alignContent: "center" }} icon="cart" mode="contained" onPress={() => { Toast.show({ type: 'success', text1: "Compra Realizado com Sucesso" }) }}>COMPRAR POR: R$ {ProductValue}</Button>
                    </View>
